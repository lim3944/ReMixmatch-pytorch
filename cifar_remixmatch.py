...
def get_cifar10(root, num_labeled, num_expand_x, num_expand_u):
    ...
    # unlabeled data, strong + weak augmentation
    train_unlabeled_dataset = CIFAR10SSL(
        root, train_unlabeled_idxs, train=True,
        transform=TransformRemix(mean=cifar10_mean, std=cifar10_std)
    )
...
def get_cifar100(root, num_labeled, num_expand_x, num_expand_u):
    ...
    train_unlabeled_dataset = CIFAR100SSL(
        root, train_unlabeled_idxs, train=True,
        transform=TransformRemix(mean=cifar100_mean, std=cifar100_std))
